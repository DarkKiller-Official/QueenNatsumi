/* Codded by @phaticusthiccy/xRASHMITH
Telegram: t.me/xRASHMITH
...
if (Build.WORKTYPE == 'private') {
    ...
    Natsumi.addCommand({Pnatsumi: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC}, (async (message, match) => {
    ...
    Natsumi.addCommand({Pnatsumi: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
