...
if (conf.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ Pnatsumi: 'voicy', desc: Lang.USAGE, fromMe: true }, (async (message, match) => {
...
if (conf.WORKTYPE == 'public') {
    ...
    Asena.addCommand({ Pnatsumi: 'voicy', desc: Lang.USAGE, fromMe: false }, (async (message, match) => {
