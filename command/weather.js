...
if (Build.WORKTYPE == 'private') {
    ...
    Asena.addCommand({Pnatsumi: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true}, async (message, match) => {
...
if (Build.WORKTYPE == 'public') {
    ...
    Asena.addCommand({Pnatsumi: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: false}, async (message, match) => {
    ...
    Asena.addCommand({Pnatsumi: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true, dontAddCommandList: true}, async (message, match) => {
