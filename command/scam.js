...
const {MessageType, MessageOptions, Mimetype, Presence} = require('queen-natsumi-web-api');

const Language = require('../language');
const Lang = Language.getString('scam');

Asena.addCommand({Pnatsumi: 'scam ?(.*)', fromMe: true, desc: Lang.SCAM_DESC}, (async (message, match) => {
