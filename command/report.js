...
if (Build.WORKTYPE == 'private') {
    Asena.addCommand({Pnatsumi: 'report ?(.*)', fromMe: true, desc: Lang.REPORT}, (async (message, match) => {
    ...
    Asena.addCommand({Pnatsumi: 'report ?(.*)', fromMe: false, desc: Lang.REPORT}, (async (message, match) => {
        if (match[1] == '' && message.reply_message) {
            let grup = await message.client.groupMetadata(message.jid);
            var jids = [];
            mesaj = '';
    ...
    Asena.addCommand({Pnatsumi: 'report ?(.*)', fromMe: true, desc: Lang.REPORT, dontAddCommandList: true}, (async (message, match) => {
        if (match[1] == '' && message.reply_message) {
            let grup = await message.client.groupMetadata(message.jid);
            var jids = [];
            mesaj = '';
