...
Natsumi.addCommand({Pnatsumi: 'speedtest', fromMe: true,  deleteCommand: false,  desc: Lang.SPEEDTEST_DESC}, (async (message, match) => {
...
Natsumi.addCommand({Pnatsumi: 'ping', fromMe: true,  deleteCommand: false, desc: Lang.PING_DESC}, (async (message, match) => {
...
Natsumi.addCommand({Pnatsumi: 'short ?(.*)', fromMe: false, desc: Lang.URL}, (async (message, match) => {
