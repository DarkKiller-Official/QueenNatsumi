...
if (Build.WORKTYPE == 'private') {
    ...
    Asena.addCommand({Pnatsumi: 'meme ?(.*)', fromMe: true, desc: Lang.MEMES_DESC}, (async (message, match) => {   
    ...
    Asena.addCommand({Pnatsumi: 'meme ?(.*)', fromMe: false, desc: Lang.MEMES_DESC}, (async (message, match) => {    
