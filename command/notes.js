...
Asena.addCommand({ Pnatsumi: 'notes', fromMe: true, desc: Lang.NOTES_USAGE }, async (message, match) => {
...
Asena.addCommand({ Pnatsumi: 'save ?(.*)', fromMe: true, desc: Lang.SAVE_USAGE }, async (message, match) => {
...
Asena.addCommand({ Pnatsumi: 'deleteNotes', fromMe: true, desc: Lang.DELETE_USAGE }, async (message, match) => {
