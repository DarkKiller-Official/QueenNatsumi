...
if (Build.LANG == 'TR' || Build.LANG == 'AZ') {
    ...
    Natsumi.addCommand({Pnatsumi: 'help ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    Natsumi.addCommand({Pnatsumi: 'help ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {
