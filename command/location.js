...
const {MessageType, GroupSettingChange} = require('queen-natsumi-web-api'); // Boredom 😬

const Language = require('../language');
const Lang = Language.getString('locate'); // Language supp. 😉


    Asena.addCommand({Pnatsumi: 'locate', fromMe: true, desc: Lang.L_DESC, warn: Lang.L_WARN}, (async (message, match) => {
