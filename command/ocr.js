...
if (Build.WORKTYPE == 'private') {
    ...
    Asena.addCommand({Pnatsumi: 'ocr ?(.*)', fromMe: true, desc: Lang.OCR_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({Pnatsumi: 'ocr ?(.*)', fromMe: false, desc: Lang.OCR_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({Pnatsumi: 'ocr ?(.*)', fromMe: true, desc: Lang.OCR_DESC, dontAddCommandList: true}, (async (message, match) => { 
