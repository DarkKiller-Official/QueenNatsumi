...
if (Build.WORKTYPE == 'private') {
    ...
    Asena.addCommand({Pnatsumi: 'unvoice', fromMe: true, desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({Pnatsumi: 'unvoice', fromMe: false, desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({Pnatsumi: 'unvoice', fromMe: true, desc: Lang.UV_DESC, dontAddCommandList: true}, (async (message, match) => {    
