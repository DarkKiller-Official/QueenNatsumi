...
clh.pay = ddd
var desc_msg = ''
if (Build.LANG == 'TR') desc_msg = 'Sınırsız erişime sahip textmaker araçlarını gösterir.'
if (Build.LANG == 'EN') desc_msg = 'Shows textmaker tools with unlimited access.'
if (Build.LANG == 'RU') desc_msg = 'Показывает инструменты для создания текстов с неограниченным доступом.'
if (Build.LANG == 'AZ') desc_msg = 'Sınırsız girişi olan textmaker alətləri göstərir.'
if (Build.LANG == 'PT') desc_msg = 'Mostra ferramentas textmaker com acesso ilimitado.'
if (Build.LANG == 'ID') desc_msg = 'Menampilkan alat pembuat teks dengan akses tak terbatas.'
if (Build.LANG == 'ML') desc_msg = 'പരിധിയില്ലാത്ത ആക്സസ് ഉള്ള ടെക്സ്റ്റ് മേക്കർ ഉപകരണങ്ങൾ കാണിക്കുന്നു.'
if (Build.LANG == 'HI') desc_msg = 'असीमित एक्सेस के साथ टेक्स्टमेकर टूल दिखाता है।'
if (Build.LANG == 'ES') desc_msg = 'Muestra herramientas de creación de textos con acceso ilimitado.'
if (os.userInfo().homedir !== clh.pay) return;
let wk = Build.WORKTYPE == 'public' ? false : true

Asena.addCommand({Pnatsumi: 'textmaker$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    var t1 = ''
    var t2 = ''
    var t3 = ''
    var t4 = ''
...
Asena.addCommand({Pnatsumi: 'textdevil ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textbear ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textwolf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textneon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'text2neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textlight ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textjoker ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textninja ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Asena.addCommand({Pnatsumi: 'textglitter ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textbokeh ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textmarvel ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Asena.addCommand({Pnatsumi: 'text2marvel ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Asena.addCommand({Pnatsumi: 'textavengers ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Asena.addCommand({Pnatsumi: 'textglitch ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Asena.addCommand({Pnatsumi: 'textgraf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Asena.addCommand({Pnatsumi: 'text2graf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Asena.addCommand({Pnatsumi: 'textlion ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Asena.addCommand({Pnatsumi: 'text3neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textice ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textspace ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
...
Asena.addCommand({Pnatsumi: 'textsmoke ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textglow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var download = async(uri, filename, callback) => {
        await request.head(uri, async(err, res, body) => {    
            await request(uri).pipe(fs.createWriteStream(filename)).on('close', callback);
        });
...
Asena.addCommand({Pnatsumi: 'textfire ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textharry ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'text4neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textcemetery ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({Pnatsumi: 'textcup ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
