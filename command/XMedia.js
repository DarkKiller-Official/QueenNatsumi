/* Codded by @CyberDraxo with @phaticusthiccy
Telegram: t.me/CyberDraxo
...
if (Build.WORKTYPE == 'private') {
    ...
    Natsumi.addCommand({Pnatsumi: 'xmedia$', fromMe: true, desc: Lang.XMEDİA_DESC}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'x4mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {caption: 'Made by QueenNatsumi'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    Natsumi.addCommand({Pnatsumi: 'mp3bass$', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'x2mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4image', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {mimetype: Mimetype.mpeg, caption: 'Made by QueenNatsumi'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));

    Natsumi.addCommand({Pnatsumi: 'spectrum', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'waves', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'frequency', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'avec', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'volumeaudio', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'cqtaudio', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3eq', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3crusher', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3reverse', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4vintage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4reverse', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4bw', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'bwimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.jpg')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.jpg'), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made by QueenNatsumi'});
        });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));

    Natsumi.addCommand({Pnatsumi: 'vintageimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4enhance', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'blurimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4blur', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3pitch', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4edge', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3low', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'x2mp3', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'edgeimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'enhanceimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3volume', fromMe: true, dontAddCommandList: true}, (async (message, match) => { 
    ...
    Natsumi.addCommand({Pnatsumi: 'gif', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output_gif.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output_gif.mp4'), MessageType.video, {mimetype: Mimetype.gif, caption: 'Made by QueenNatsumi'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));

    Natsumi.addCommand({Pnatsumi: 'agif', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'grenimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'interp ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        exec('ffprobe -hide_banner -loglevel fatal -show_error -show_format -show_streams -show_programs -show_chapters -show_private_data -print_format json ' + location, async (err, st, stderr) => {
            ...
            ffmpeg(location)
                ...
                .on('progress', async (progress) => {
                    ...
                    while (l > 10 && dam == 10) {
                        dam = 1
                        let yon = Build.LANG == 'TR' || Build.LANG == 'AZ' ? '*%10 Tamamlandı!*' : '*Completed %10!*'
                    ...
                    while (l > 30 && dam == 1) {
                        dam = 2
                        let yotuz = Build.LANG == 'TR' || Build.LANG == 'AZ' ? '*%30 Tamamlandı!*' : '*Completed %30!*'
                    ...
                    while (l > 50 && dam == 2) {
                        dam = 3
                        let yelli = Build.LANG == 'TR' || Build.LANG == 'AZ' ? '*%50 Tamamlandı!*' : '*Completed %50!*'
                    ...
                    while (l > 70 && dam == 3) {
                        dam = 4
                        let yetmis = Build.LANG == 'TR' || Build.LANG == 'AZ' ? '*%70 Tamamlandı!*' : '*Completed %70!*'
                    ...
                    while (l > 90 && dam == 4) {
                        dam = 5
                        let vprocc = Build.LANG == 'TR' || Build.LANG == 'AZ' ? '*Video Hazırlanıyor..*' : '*Preparing Video..*'
    ...
    Natsumi.addCommand({Pnatsumi: 'rainbowimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4rainbow', fromMe: true, dontAddCommandList: true}, (async (message, match) => {  
    ...
    Natsumi.addCommand({Pnatsumi: 'negativeimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {  
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4negative', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4art', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'artimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4stab', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4color', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'colorimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4slowmo', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('slowmo.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('slowmo.mp4'), MessageType.video, {caption: 'True Slow-Motion by QueenNatsumi'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
}
    ...
    Natsumi.addCommand({Pnatsumi: 'xmedia$', fromMe: false, desc: Lang.XMEDİA_DESC}, (async (message, match) => {    
        if (Build.LANG == 'TR' || Build.LANG == 'AZ') {
            await message.sendMessage('💻Usage: *.mp4enhance*\nℹ️Desc: 🇹🇷 Videnun kalitesini artırır.\n\n💻Usage: *.interp*\nℹ️Desc: 🇹🇷 Videonun FPS değerini arttırır.\n\n💻Usage: *.mp4slowmo*\nℹ️Desc: 🇹🇷 Ağır çekim olmayan videolara true-slowmo uygular.\n\n💻Usage: *.x4mp4*\nℹ️Desc: 🇹🇷 Video Kalitesini 4 kat düşürür.\n\n💻Usage: *.x2mp4*\nℹ️Desc: 🇹🇷 Video Kalitesini 2 kat düşürür.\n\n💻Usage: *.gif*\nℹ️Desc: 🇹🇷 Videoyu gif’e çevirir.\n\n💻Usage: *.agif*\nℹ️Desc: 🇹🇷 Videoyu sesli gif’e çevirir.\n\n💻Usage: *.mp4blur*\nℹ️Desc: 🇹🇷 Video arka planını bulanıklaştırır.\n\n💻Usage: *.mp4stab*\nℹ️Desc: 🇹🇷 Videonun titreşimini azaltır.\n\n💻Usage: *.mp4rainbow*\nℹ️Desc: 🇹🇷 Videoya gökkuşağı efekti uygular.\n\n💻Usage: *.mp4color*\nℹ️Desc: 🇹🇷 Videonun renklerini daha canlı ve çekici yapar.\n\n💻Usage: *.mp4art*\nℹ️Desc: 🇹🇷 Videoya çizim efekti uygular.\n\n💻Usage: *.mp4negative*\nℹ️Desc: 🇹🇷 Videoya negatif renk filtresi uygular.\n\n💻Usage: *.mp4vintage*\nℹ️Desc: 🇹🇷 Videoya nostaji efekti uygular.\n\n💻Usage: *.mp4bw*\nℹ️Desc: 🇹🇷 Videoya monochrome efekti uygular.\n\n💻Usage: *.mp4reverse*\nℹ️Desc: 🇹🇷 Videoyu tersten oynatır.\n\n💻Usage: *.mp4edge*\nℹ️Desc: 🇹🇷 Videoya edge efekti uygular.\n\n💻Usage: *.mp4image*\nℹ️Desc: 🇹🇷 Fotoğrafı 5 saniyelik videoya çevirir.\n\n💻Usage: *.spectrum*\nℹ️Desc: 🇹🇷 Sesin spektrum görüntüsünü video yapar.\n\n💻Usage: *.waves*\nℹ️Desc: 🇹🇷 Sesin dalga aralığını videoya çevirir.\n\n💻Usage: *.frequency*\nℹ️Desc: 🇹🇷 Sesin frekans aralığını videoya çevirir.\n\n💻Usage: *.avec*\nℹ️Desc: 🇹🇷 Sesin farklı bir histogramını videoya çevirir.\n\n💻Usage: *.volumeaudio*\nℹ️Desc: 🇹🇷 Sesin Desibel Değerini Videoya Dönüştürür.\n\n💻Usage: *.cqtaudio*\nℹ️Desc: 🇹🇷 Ses CQT değerini videoya çevirir.\n\n💻Usage: *.mp3eq*\nℹ️Desc: 🇹🇷 Sesi kristal berraklık düzeyinde ayarlar.\n\n💻Usage: *.mp3crusher*\nℹ️Desc: 🇹🇷 Sesi bozar ve gülünç hale getirir.\n\n💻Usage: *.mp3reverse*\nℹ️Desc: 🇹🇷 Sesi Tersen Oynatır.\n\n💻Usage: *.mp3bass* \nℹ️Desc: 🇹🇷 Müziğin bass düzeyini, sesi bozmadan arttırır.\n\n💻Usage: *.mp3pitch*\nℹ️Desc: 🇹🇷 Sesi inceltir ve hızlandırır.\n\n💻Usage *.mp3low*\nℹ️Desc: 🇹🇷 Sesi kalınlaştırır ve yavaşlatır.\n\n💻Usage: *.x2mp3*\nℹ️Desc: 🇹🇷 Sesi 2 kat hızlandırır.\n\n💻Usage: *.mp3volume*\nℹ️Desc: 🇹🇷 Ses seviyesini fazalca arttırır.\n\n💻Usage: *.bwimage*\nℹ️Desc: 🇹🇷 Fotoğrafa monochrome efekti uygular.\n\n💻Usage: *.vintageimage*\nℹ️Desc: 🇹🇷 Fotoğrafa vintage efekti uygular.\n\n💻Usage: *.edgeimage*\nℹ️Desc: 🇹🇷 Fotoğrafa edge efekti uygular.\n\n💻Usage: *.enhanceimage*\nℹ️Desc: 🇹🇷 Fotoğrafı daha net hale getirir.\n\n💻Usage: *.blurimage*\nℹ️Desc: 🇹🇷 Fotoğrafın arka planını bulanıklaştırır.\n\n💻Usage: *.grenimage*\nℹ️Desc: 🇹🇷 Fotoğrafa gren efekti uygular.\n\n💻Usage: *.negativeimage*\nℹ️Desc: 🇹🇷 Fotoğrafa negatif renk filtresi uygular.\n\n💻Usage: *.rainbowimage*\nℹ️Desc: 🇹🇷 Fotoğrafa gökkuşağı efekti uygular.\n\n💻Usage: *.colorimage*\nℹ️Desc: 🇹🇷 Fotoğrafın renklerini daha canlı ve çekici yapar.\n\n💻Usage: *.artimage*\nℹ️Desc: 🇹🇷 Fotoğrafa çizim efekti uygular.');
        } else { 
            await message.sendMessage('💻Usage: *.mp4enhance*\nℹ️Desc: 🇬🇧 Enhance video’s quality.\n\n💻Usage: *.interp*\nℹ️Desc: 🇬🇧 Increases the FPS of the video.\n\n💻Usage: *.mp4slowmo*\nℹ️Desc: 🇬🇧 Applies true-slowmo to non-slow motion videos.\n\n💻Usage: *.x4mp4*\nℹ️Desc: 🇬🇧 Reduce video’s quality by 75%.\n\n💻Usage: *.x2mp4*\nℹ️Desc: 🇬🇧 Reduce video’s quality by 50%.\n\n💻Usage: *.gif*\nℹ️Desc: 🇬🇧 Converts video to gif.\n\n💻Usage: *.agif*\nℹ️Desc: 🇬🇧 Converts video to voiced gif.\n\n💻Usage: *.mp4blur*\nℹ️Desc: 🇬🇧 Blurs the background of the video.\n\n💻Usage: *.mp4stab*\nℹ️Desc: 🇬🇧 Decreases the vibration of the video.\n\n💻Usage: *.mp4rainbow*\nℹ️Desc: 🇬🇧 Applies a rainbow effect to video.\n\n💻Usage: *.mp4color*\nℹ️Desc: 🇬🇧 Makes the colors of the video more vivid and beautiful.\n\n💻Usage: *.mp4art*\nℹ️Desc: 🇬🇧 Applies a art effect to the video.\n\n💻Usage: *.mp4negative*\nℹ️Desc: 🇬🇧 Applies a negative color filter to the video.\n\n💻Usage: *.mp4vintage*\nℹ️Desc: 🇬🇧 Applies a nostalgic effect to video.\n\n💻Usage: *.mp4bw*\nℹ️Desc: 🇬🇧 Applies a monochrome effect to video.\n\n💻Usage: *.mp4reverse*\nℹ️Desc: 🇬🇧 Plays the video in reverse.\n\n💻Usage: *.mp4edge*\nℹ️Desc: 🇬🇧 Applies a edge effect to the video.\n\n💻Usage: *.mp4image*\nℹ️Desc: 🇬🇧 Converts photo to 5 sec video.\n\n💻Usage: *.spectrum*\nℹ️Desc: 🇬🇧 Converts the spectrum of sound into video.\n\n💻Usage: *.waves*\nℹ️Desc: 🇬🇧 Converts the wave range of sound to video.\n\n💻Usage: *.frequency*\nℹ️Desc: 🇬🇧 Converts the frequency range of sound to video.\n\n💻Usage: *.avec*\nℹ️Desc: 🇬🇧 Converts the histogram of sound to video.\n\n💻Usage: *.volumeaudio*\nℹ️Desc: 🇬🇧 Converts the decibel value of the sound into video.\n\n💻Usage: *.cqtaudio*\nℹ️Desc: 🇬🇧 Converts the CQT value of audio to video.\n\n💻Usage: *.mp3eq*\nℹ️Desc: 🇬🇧 Adjusts the sound to a crystal clear level.\n\n💻Usage: *.mp3bass* \nℹ️Desc: 🇬🇧 Adds crystal bass without distorting the sound.\n\n💻Usage: *.mp3crusher*\nℹ️Desc: 🇬🇧 Distorts the sound, makes ridiculous.\n\n💻Usage: *.mp3reverse*\nℹ️Desc: 🇬🇧 Plays the sound in reverse.\n\n💻Usage: *.mp3pitch*\nℹ️Desc: 🇬🇧 Makes the sound thinner and faster.\n\n💻Usage *.mp3low*\nℹ️Desc: 🇬🇧 Makes the sound deep and slower.\n\n💻Usage: *.x2mp3*\nℹ️Desc: 🇬🇧 Makes the sound twice as fast.\n\n💻Usage: *.mp3volume*\nℹ️Desc: 🇬🇧 Increase sound level so much.\n\n💻Usage: *.bwimage*\nℹ️Desc: 🇬🇧 Applies a monochrome effect to image.\n\n💻Usage: *.vintageimage*\nℹ️Desc: 🇬🇧 Applies a vinatge effect to photo.\n\n💻Usage: *.edgeimage*\nℹ️Desc: 🇹🇷 Fotoğrafa edge efekti uygular.\n🇬🇧 Applies a edge effect to the photo.\n\n💻Usage: *.enhanceimage*\nℹ️Desc: 🇹🇷 Fotoğrafı daha net hale getirir.\n🇬🇧 Makes the photo clearer.\n\n💻Usage: *.blurimage*\nℹ️Desc: 🇹🇷 Fotoğrafın arka planını bulanıklaştırır.\n🇬🇧 Blurs the background of the photo.\n\n💻Usage: *.grenimage*\nℹ️Desc: 🇹🇷 Fotoğrafa gren efekti uygular.\n🇬🇧 Applies grain effect to the photo.\n\n💻Usage: *.negativeimage*\nℹ️Desc: 🇬🇧 Applies a negative color filter to the photo.\n\n💻Usage: *.rainbowimage*\nℹ️Desc: 🇬🇧 Applies rainbow effect to the photo.\n\n💻Usage: *.colorimage*\nℹ️Desc: 🇬🇧 It makes the colors of the photo more vivid and attractive.\n\n💻Usage: *.artimage*\nℹ️Desc: 🇬🇧 Applies a art effect to the photo.');
    ...
    Natsumi.addCommand({Pnatsumi: 'x4mp4', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'x2mp4', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4image', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'spectrum', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'waves', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'frequency', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'avec', fromMe: false, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'volumeaudio', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'cqtaudio', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3eq', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3crusher', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3reverse', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4vintage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4reverse', fromMe: false, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4bw', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'bwimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'vintageimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4enhance', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'blurimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4blur', fromMe: false, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3pitch', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4edge', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3low', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'x2mp3', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'edgeimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'enhanceimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp3volume', fromMe: false, dontAddCommandList: true}, (async (message, match) => { 
    ...
    Natsumi.addCommand({Pnatsumi: 'gif', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'agif', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'grenimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'interp ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
        if (message.reply_message === false && match[1] === '') return await message.sendMessage('*Need Video and FPS Value!*\nEx: ```.interp 100```');
        if (match[1] <= 10) return await message.sendMessage('*Low FPS Value ⚠️*\n*Please, type over 10*');
        if (match[1] >= 500) return await message.sendMessage('*High FPS Value ⚠️*\n*Please, type under 500*');
        await message.client.sendMessage(message.jid,'```Interpolating..```',MessageType.text);
    ...
    Natsumi.addCommand({Pnatsumi: 'rainbowimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4rainbow', fromMe: false, dontAddCommandList: true}, (async (message, match) => {  
    ...
    Natsumi.addCommand({Pnatsumi: 'negativeimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {  
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4negative', fromMe: false, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4art', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'artimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4stab', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4color', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'colorimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Natsumi.addCommand({Pnatsumi: 'mp4slowmo', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
