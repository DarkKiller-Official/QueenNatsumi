...
if (Build.WORKTYPE == 'private') {
    Asena.addCommand({Pnatsumi: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({Pnatsumi: 'sticker$', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
