...
const pb = require('../Build');

if (pb.WORKTYPE == 'private') {
    Asena.addCommand({ Pnatsumi: '.', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    Asena.addCommand({ Pnatsumi: '.', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        if(message.fromMe) return
        let command = [ 
        'xmedia',
        'install',
